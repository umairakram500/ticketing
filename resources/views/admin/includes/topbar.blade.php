    ...
    <ul id="header-actions" class="clearfix">
        {{--<li class="list-box hidden-xs dropdown">
            ...
            <ul class="dropdown-menu imp-notify">
                ...
                <li>
                    <div class="icon">
                        <img src="{{ asset('img/thumbs/user6.png') }}" alt="Arise Admin">
                    </div>
                    <div class="details">
                ...
                <li>
                    <div class="icon">
                        <img src="{{ asset('img/thumbs/user1.png') }}" alt="Arise Admin">
                    </div>
                    <div class="details">
        ...
        <li class="list-box user-admin hidden-xs dropdown">
            <div class="admin-details">
                ...
                <div class="designation">{{ auth()->user()->role->name ?? '' }}</div>
            </div>
            ...
            <ul class="dropdown-menu sm">
                <li class="dropdown-content">
                    ...
                    <a href="{{ route('admin.login.changePass.form') }}">Change Password</a>
